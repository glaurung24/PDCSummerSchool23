...
int main(int argc, char *argv[]) {
    ...
    OMP_FUNCTIONS::run_calculation(layer, layer_size, storms, num_storms, maximum, positions);    
    ...
    #ifdef DEBUG
    OMP_FUNCTIONS::debug_print( layer_size, layer, positions, maximum, num_storms );
    #endif
